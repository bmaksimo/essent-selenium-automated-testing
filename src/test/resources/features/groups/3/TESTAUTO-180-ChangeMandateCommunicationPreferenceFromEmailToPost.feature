...
Feature: TESTAUTO-180 - Change MANDATE communication preference from EMAIL to POST

    Background:
        Given I login as API user "soapui_b2c"
    @TESTAUTO-180
    Scenario: Change MANDATE communication preference from EMAIL to POST
        ...
        And Click on Plus action of table "Communicatievoorkeuren" at row where "COMMUNICATIETYPE" is "Mandaat" and click on "Update"
        And "E-mailadres" E-mailadres input is cleared
