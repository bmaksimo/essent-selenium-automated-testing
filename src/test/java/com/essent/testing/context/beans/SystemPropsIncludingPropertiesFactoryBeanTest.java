...
public class SystemPropsIncludingPropertiesFactoryBeanTest {
  ...
  SystemPropsIncludingPropertiesFactoryBean factoryBean =
      new SystemPropsIncludingPropertiesFactoryBean();

  @Before
  public void beforeEachTest() {
    factoryBean.setLocation(
        new ClassPathResource("SystemPropsIncludingPropertiesFactoryBeanTest.properties"));
  }
