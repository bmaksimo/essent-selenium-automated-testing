...
public class GeckoDriverTest {
  ...
  private static final String PATH_TO_GECKO_DRIVER =
      "C:/Users/dmitr/scoop/apps/geckodriver/0.19.1/geckodriver.exe";
  private static final String PATH_TO_FIREFOX_PROFILE =
      "C:/Users/dmitr/AppData/Local/Mozilla/Firefox/Profiles/DWP Testing";

  public static void main(String[] args) throws MalformedURLException {

    if (StringUtils.isEmpty(System.getProperty(GECKO_DRIVER_PROPERTY_KEY))) {
      System.setProperty(
          "webdriver.gecko.driver", "C:/Users/dmitr/scoop/apps/geckodriver/0.19.1/geckodriver.exe");
    }
