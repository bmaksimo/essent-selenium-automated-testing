...
Feature: NUAT-510 Triggering advance invoice run. Check is invoice created in DWP and jbilling
    ...
    Scenario: Trigger Invoice run process
        ...
        And B2B Active Contract is "UP" product type and use "FAKE" address and switch type is "SUPPLIER SWITCH"
        ...
        #And JBilling "LOGIN NAME" input is "1000955356"
        ...
        #And JBilling First cell value in first row is "VKM6800003198"
        When JBilling Click on row "1" in Table
        Then JBilling label "Invoice Number" contains value "parameter:ID & Type" at column "2"
        #Then JBilling label "Invoice Number" contains value "VKM6800003198" at column "2"
        ...
        When JBilling top menu item is "Orders"
				...
				#Then JBilling label "User Name:" contains value "1000955356" at column "2"
