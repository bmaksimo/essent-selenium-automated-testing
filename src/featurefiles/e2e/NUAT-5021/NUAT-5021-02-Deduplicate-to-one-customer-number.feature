...
#        And "Status contractlijn" selection is "Actief"
        ...
        And "Voornaam" input is "Aman"
        And "Familienaam" input is "Van tricht"
        And "E-mailadres" input is "aman.vantricht@example.com"
        And "Geboortedatum" input is "09/02/1969"
        And "Gsm-nummer" input is "+31687837471"
