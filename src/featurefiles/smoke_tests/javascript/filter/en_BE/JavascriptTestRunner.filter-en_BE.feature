...
Feature: Javascript DWP testing
    ...
    Scenario:
<<<<<<< HEAD:src/featurefiles/smoke_tests/javascript/filter/JavascriptTestRunner.filter.feature
...
>>>>>>> develop:src/featurefiles/smoke_tests/javascript/filter/en_BE/JavascriptTestRunner.filter-en_BE.feature
