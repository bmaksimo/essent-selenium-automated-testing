...
public class ConsumptionService {
  ...
  private static final String ELECTRICITY_LOW_HIGH_EXCLUSIVE_NIGHT =
      "electricity_high_low_exclusivenight.xml";
  private static final String ELECTRICITY_TOTAL_HOUR_EXCLUSIVE_NIGHT =
      "electricity_totalhour_exclusivenight.xml";
  private static final String ELECTRICITY_TOTAL_HOUR = "electricity_totalhours.xml";
  private static final String ELECTRICITY_LOW_HIGH_TOTAL_HOUR =
      "electricity_high_low_total_hours.xml";
  ...
  private Optional<String> getConsumptionRequest(ConsumptionRecord consumptionRecord) {
    ...
    String fromDate =
        StringUtils.isBlank(consumptionRecord.getStartDate())
            ? DateTime.now().toString("yyyy-MM-dd")
            : consumptionRecord.getStartDate();
  ...
  private Optional<String> getConsumptionRequestFromTemplate(
      Map<String, String> data, ConsumptionRecord consumptionRecord) {
    try {
  ...
  private Map<String, String> getFileTypeMapping() {
    ...
    fileTypeMapping.put(
        ConsumptionMeterType.LOW_HIGH_NIGHT_EXCLUSIVE.value, ELECTRICITY_LOW_HIGH_EXCLUSIVE_NIGHT);
    fileTypeMapping.put(ConsumptionMeterType.TOTAL_HOUR.value, ELECTRICITY_TOTAL_HOUR);
    fileTypeMapping.put(
        ConsumptionMeterType.TOTAL_HOUR_NIGHT_EXCLUSIVE.value,
        ELECTRICITY_TOTAL_HOUR_EXCLUSIVE_NIGHT);
    fileTypeMapping.put(
        ConsumptionMeterType.LOW_HIGH_TOTAL_HOUR.value, ELECTRICITY_LOW_HIGH_TOTAL_HOUR);
