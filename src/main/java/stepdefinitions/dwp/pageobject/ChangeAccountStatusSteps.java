...
public class ChangeAccountStatusSteps extends DwpScenario {
  @Before(
      "@SMOKE or @QUOTE or @QUOTE_CS or @QUOTE_MI or @QUOTE_SS or @BILLING or @B2B_REGRESSION or @REGRESSION or @E2E or @B2C")
  ...
  @Override
  @After(
      "@SMOKE or @QUOTE or @QUOTE_CS or @QUOTE_MI or @QUOTE_SS or @B2B_REGRESSION or @REGRESSION or @B2C")
