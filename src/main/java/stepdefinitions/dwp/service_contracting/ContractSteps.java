...
public class ContractSteps extends DwpScenario {
  ...
  public void checkIfTheEndDateOfNewEanIsTheSameDateAsTheEndDateOfTheOldOne() {
    ...
    Assert.assertEquals(
        ...
        parameterProvider.getValueOrParameterAsString("parameter:endDate"));
  }
  ...
  public void checkIfPricesOfBothContractsAreTheSame() {
    ...
    Assert.assertEquals(
        ...
        parameterProvider.getValueOrParameterAsString("parameter:energieprijsEnkelvoudigInclBtw"));
    Assert.assertEquals(
    ...
    Assert.assertEquals(
        ...
        parameterProvider.getValueOrParameterAsString("parameter:energieprijsNachtInclBtw"));
    Assert.assertEquals(
    ...
    Assert.assertEquals(
        ...
        parameterProvider.getValueOrParameterAsString("parameter:energieprijsEnkelvoudigExclBtw"));
    Assert.assertEquals(
    ...
    Assert.assertEquals(
        ...
        parameterProvider.getValueOrParameterAsString("parameter:energieprijsNachExclBtw"));
    Assert.assertEquals(
  ...
  public void interactionIsCreatedWithTypeAndOnderwerpAndVerwanteCaseIs(
    ...
    Assert.assertEquals(
        "Actual Interaction Type differs from expected", type, sp.getInteractionType(type));
    Assert.assertEquals(
  ...
  public void twoContractsAreDisplayed() {
    ContractPage cp = new ContractPage();
    Assert.assertEquals(
        "The number of electricity contracts is not 2", 2, cp.getNumberOfElectricityContracts());
  }
  ...
  public void thereIsOneBillingCustomer() {
    ...
    Assert.assertEquals(
        "The number of billing customers is not 1", 1, dp.getNumberOfBillingCustomers());
  }
  ...
  public void checkProspectCustomerInformation(final DataTable dbTable) {
    ...
    Assert.assertEquals(
        "Actual address differs from expected", address.replaceAll("\n", " "), info.get(1).get(0));
  ...
  public void checkContract(final DataTable dbTable) {
    ...
    Assert.assertEquals(
        "Actual status differs from expected", cp.getStatusFromContracten(), status);
    ...
    Assert.assertEquals(
        "Actual product differs from expected", cp.getProductFromContracten(), product);
  }
