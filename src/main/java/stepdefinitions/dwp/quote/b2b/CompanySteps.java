...
public class CompanySteps extends DwpScenario {
  ...
  private boolean isCompanyAccepted() {
    ...
    String currentStatus =
        new NonEditableImpl().getValue("Perform customer acceptance check", "Klantacceptatie");
  ...
  public void generateContactInfo() {
    CustomerDetails customerDetails =
        (CustomerDetails)
            parameterProvider.getValueOrParameter("parameter:suitecrm-company-account");
