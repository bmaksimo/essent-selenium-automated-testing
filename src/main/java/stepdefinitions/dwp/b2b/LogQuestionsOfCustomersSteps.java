...
public class LogQuestionsOfCustomersSteps extends DwpScenario {
  ...
  public void checkSuccess() {
    ...
    assertTrue(
        "Actual complaint text: "
            + cdp.getComplaintText()
            + " is different from expected: "
            + complaintText,
        cdp.getComplaintText().equalsIgnoreCase(complaintText));
    assertTrue(
        "Actual solution field text: "
            + cdp.getSolutionFieldText()
            + " is different from expected: "
            + solutionText,
        cdp.getSolutionFieldText().equalsIgnoreCase(solutionText));
  ...
  public void createCaseForAccount() {
    ...
    assertThat("Log Case Form was not filled in", success, is(true));
