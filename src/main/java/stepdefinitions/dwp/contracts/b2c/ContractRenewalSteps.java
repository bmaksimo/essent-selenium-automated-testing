...
public class ContractRenewalSteps extends NavigationElements {
  ...
  public void checkIfOurIsCoveredByAValidTariffsheetperiodFromTable(
      String intervalParameter, String table) {
    ...
    fail(String.format("Renewal period %s is not covered by a tariffsheet", intervalParameter));
  }
