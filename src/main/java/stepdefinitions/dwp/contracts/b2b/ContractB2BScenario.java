...
public class ContractB2BScenario extends RegisteredScenario {
    ...
    @Given("^B2B sined quote by customer, \"([^\"]*)\" product type and use \"([^\"]*)\" address and switch type is \"([^\"]*)\"$")
    public String createB2BQuoteSignByCustomer(String productType, String isFakeAddress, String switchType) {
