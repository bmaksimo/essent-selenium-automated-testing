...
public class TaskSteps extends DwpScenario {
  ...
  @When(
      "^Plus action and Mark As Done/Markeren Als Verwerkt of first customer from list waiting for (\\d+) seconds$")
  ...
  public void searchForTaskId() {
    ...
    contractenPage.searchForTaskId(
        parameterProvider.getValueOrParameterAsString("parameter:contractNumber"));
  }
