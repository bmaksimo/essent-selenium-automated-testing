...
public class ViewListChecks extends NavigationElements {
	...
	logger().info(
		String.format("- STEP: View list header is \"%s\" within %s second(s) - PASSED.", header, seconds));
    }
	...
	FluentWait<ClickTableCellUrl> waiter = waiter(new ClickTableCellUrl(), seconds, 5).withMessage(
		String.format("Failed click on link in view list at \"%s\" row and \"%s\" column within \"%s\" seconds",
    ...
    public void collectViewListElementWithAliasAsParameter(String viewListElement, String viewListElementAlias,
	    String ordinal) {
	String parameter = getViewListElementAtRow(viewListElement, ordinal);
    ...
    public void viewListContainsValueAtColumnWithFixedTime(String table, String value, String column, int waitingTime)
	    throws Throwable {
