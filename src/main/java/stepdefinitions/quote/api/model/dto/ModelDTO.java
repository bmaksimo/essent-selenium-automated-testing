...
public class ModelDTO {
  ...
  @JsonProperty(
      "dwp|accounts|aos_quotes|payment_details|payment_methods|payment_method|matchedCondition")
  private String paymentMethodMatchedCondition;

  @JsonProperty(
      "leads_contact_details(contact_details_phone_type='Mobile phone';contact_details_type='Phone')|id")
  ...
  @JsonProperty(
      "dwp|accounts|aos_quotes|payment_details|com_prefs(type='LEGAL')|channel|matchedCondition")
  ...
  @JsonProperty(
      "leads_contact_details(contact_details_phone_type='Work phone';contact_details_type='Phone')|id")
  ...
  @JsonProperty(
      "dwp|accounts|aos_quotes|payment_details|com_prefs(type='MANDATE')|channel|matchedCondition")
  ...
  @JsonProperty(
      "leads_contact_details(contact_details_phone_type='Work phone';contact_details_type='Phone')|contact_details_value")
  ...
  @JsonProperty(
      "leads_contact_details(contact_details_phone_type='Mobile phone';contact_details_type='Phone')|contact_details_value")
  ...
  public String getSignDateC() {
    return sign_date_c;
  }

  public void setSignDateC(String signInDate) {
    this.sign_date_c = sign_date_c;
  }

  public String getPricingDateC() {
    return sign_date_c;
  }

  public void setPricingDateC() {
    this.pricing_date_c = pricing_date_c;
  }
