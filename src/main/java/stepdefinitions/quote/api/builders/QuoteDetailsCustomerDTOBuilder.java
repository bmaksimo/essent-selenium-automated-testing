...
public class QuoteDetailsCustomerDTOBuilder {
  private static String PATH_TO_CUSTOMER_QUOTE =
      ConfigProvider.getProperty(ConfigKey.CRM_PATH_TO_QUOTE_CUSTOMER);
  private static String PATH_TO_PAYLOAD = ConfigProvider.getProperty(ConfigKey.CRM_PATH_TO_PAYLOAD);
  private static String PATH_TO_PAYLOAD_CUSTOMER =
      ConfigProvider.getProperty(ConfigKey.CRM_PATH_TO_PAYLOAD_CUSTOMER);
  ...
  public QuoteDetailsCustomerDTOBuilder withPayloadCustomer(
      String area, String tariffSheetId, String ean) throws IOException {
