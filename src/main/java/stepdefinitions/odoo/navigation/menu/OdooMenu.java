...
public class OdooMenu extends OdooScenario {
  ...
  public void clickDownloadCoda(String value) {
    ...
    if (buttons.isEmpty()) throw new CucumberException("Coda download button was not found");
  ...
  public void odooContainsModalTitle(String modalTitle) {
    ...
    if (null == title || StringUtils.isBlank(title.getText()))
      throw new CucumberException("Title was not found");
    assertThat(
  ...
  public void odooClickOnTab(String tab) {
    FluentWait<CustomerPage> waiter =
        waiter(new CustomerPage(), 60, 5)
  ...
  public void odooValidateBankAccountWasChangedOn(String iban) {
    ...
    FluentWait<CustomerPage> waiter =
        waiter(new CustomerPage(), 600, 20)
