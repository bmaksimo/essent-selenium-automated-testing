...
public class AdvancedSearchComponent extends Component {
  ...
  private static final String ADVANCED_SEARCH_DRAWER_TOGGLE_SELECTOR =
      "//div[@class='oe_searchview_unfold_drawer']";
  private static final String ADVANCED_SEARCH_VIEW_SELECTOR =
      "//div[@class='oe_searchview_advanced']/h4";
  private static final String PROPERTIES_LIST_SELECTOR =
      "//select[@class='searchview_extended_prop_field']";
  private static final String OPERATORS_LIST_SELECTOR =
      "//select[@class='searchview_extended_prop_op']";
  private static final String SEARCH_TERM_INPUT_SELECTOR =
      "//span[@class='searchview_extended_prop_value']/input";
  ...
  private void fillInAdvancedSearchForm(AdvancedSearch advancedSearch) {
    ...
    new Select(getOperatorsList())
        .selectByVisibleText(advancedSearch.getAdvancedSearchOperator().getOperator());
