...
public class OdooDunningSteps extends OdooScenario {
  ...
  public void dunningInstanceDescription(String expectedDescription) throws Exception {
    ...
    String message =
        String.format("Dunning instance description is not \"%s\"", expectedDescription);
  ...
  public void dunningInstanceLetterState(String expectedLetterState) throws Exception {
    ...
    String message =
        String.format("Dunning instance letter state is not \"%s\"", expectedLetterState);
  ...
  public void dunningInvoiceNumber(String invoiceNumber) {
    ...
    Assert.assertThat(
        message,
        dunningOdooInvoiceNumber.substring(0, dunningOdooInvoiceNumber.indexOf(" (")),
        equalTo(dunningDWPInvoiceNumber));
  }
  ...
  private List<WebElement> getHB1Row() throws Exception {
    ...
    return new DunningInstancePage()
        .selectRowOnTable("", filters, parameterProvider.getCurrentContextParameters());
  }
