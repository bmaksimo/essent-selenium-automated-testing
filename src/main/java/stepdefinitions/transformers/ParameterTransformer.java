...
final class ParameterTransformer implements ParameterByTypeTransformer {
    ...
    private String getInput(String fromValue) {
        ParameterProvider parameterProvider = ((ParameterProvider) ContextService.getContext().getBean("parameterStorage"));
...
//        }
        ...
        if (toValueClass.isEnum()) {
            ...
            throw new CucumberException("Can't transform '" + fromValue + "' to " + toValueType + ". " +
