package com.billinghouse.testautomation.util.ssh;
...
public class JSchUtil {
  ...
  public void sftpPut(final String sftpHost, final String remoteDir, final String localFilePath)
  ...
  private void channelSftpPut(final String remoteDir, final String localFilePath)
      throws JSchException {
  ...
  private InputStream createInputStream(String localFilePath) throws FileNotFoundException {
    ...
    if (!localFile.exists() || localFile.isDirectory()) {
      throw new CucumberException(
          "Cannot sftp transfer file at path "
              + localFilePath
              + ", eiither it doesn't exist or it is directory");
    }
