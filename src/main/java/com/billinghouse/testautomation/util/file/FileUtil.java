...
public class FileUtil {
  ...
  public static final String DESTINATION_LOCATION =
      System.getProperty("user.dir") + File.separator + "target" + File.separator;

  public static String getSoctarFileFromTemplate(
      String custId, String eanId, String soctarStartDatEndDate) throws IOException {
    String sourcePath = DEFAULT_SOCTAR_LOCATION + "soctar-template.csv";
    String destinationPath =
        DESTINATION_LOCATION + String.format("soctar-%s-%s.csv", custId, eanId);
    ...
    try (BufferedReader br = new BufferedReader(new FileReader(sourcePath));
      ...
      StrSubstitutor substitutor =
          createStringSubstitutor(eanId, soctarStartDatEndDate, custIdPadded);
      String sCurrentLine;
  ...
  private static StrSubstitutor createStringSubstitutor(
      String eanId, String soctarStartDatEndDate, String custIdPadded) {
