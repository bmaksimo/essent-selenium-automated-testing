...
/**
 * Expands registered Javascript class and options to Javascript invocation string, executed by
 * Selenium
 */
public interface JsTestExpanderService {

  /**
   * Defines the contract of expanding registered Javascript class, and arguments, in single string
   * for Selenium JS executor
   *
