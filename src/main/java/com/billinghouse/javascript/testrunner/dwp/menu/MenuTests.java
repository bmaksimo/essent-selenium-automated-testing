...
public enum MenuTests {
    ...
    GET_TOP_ACTION("var runner = new TestRunner('get_top_action', {menu: '${value}'}, arguments[arguments.length - 1]);"),
    ...
    // Use GET_TOP_ACTION instead
    @Deprecated GET_TOP_MENU("var runner = new TestRunner('get_top_menu', {menu: '${value}'}, arguments[arguments.length - 1]);");
