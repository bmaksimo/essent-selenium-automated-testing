...
public class ParameterProvider {
  ...
  public Object put(String key, Object value) {
    ...
    if (scenarioHasChanged(this.newScenario)) this.flush();
    ...
    log.info(
        this.currentScenario.getName()
            + this.currentScenario.getSourceTagNames().toString()
            + " parameters: "
            + this.toString());
  ...
  public void setNewScenario(Scenario newScenario) {
    ...
    if (this.currentScenario == null) this.currentScenario = newScenario;
  }
