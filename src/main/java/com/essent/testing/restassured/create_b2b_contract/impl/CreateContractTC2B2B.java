...
public class CreateContractTC2B2B extends CreateQuoteB2BBase implements CreateQuoteB2B {
	...
	private static final Logger logger = Logger.getLogger(CreateContractTC2B2B.class);
	
	public CreateContractTC2B2B() throws FileNotFoundException, IOException{
		super();
		getQuoteProperties(ConstantsContractB2B.PATH_TO_PROPERTIES_FILE_CREATE_QUOTE_B2B_TC2);
	}
	...
	public String createContractB2B() throws Exception {
		...
		if (numberOfAttempts < ConstantsContractB2B.MAX_NUMBER_OF_ATTEMPTS_TO_FIND_APPROPRIATE_START_CONTRACT_DATE) {
			...
			ContractStatus contractStatus = checkContractIsActive(ConstantsContractB2B.PATH_TO_JSON_FILES_QUOTE_TC2_B2B);
