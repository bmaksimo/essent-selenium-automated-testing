...
public class ContractConstants {
	...
	public static final String PATH_TO_JSON_FILES_QUOTE_TC1_B2B = ResourceUtil.toPath("/data/contract/b2b/payloads_create_quote_contract_b2b_tc1/");
	public static final String PATH_TO_JSON_FILES_QUOTE_TC1_B2C = ResourceUtil.toPath("/data/contract/b2c/payloads_create_quote_contract_b2c_tc1/");
