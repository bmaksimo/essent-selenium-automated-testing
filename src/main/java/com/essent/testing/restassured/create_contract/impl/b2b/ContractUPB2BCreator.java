...
public class ContractUPB2BCreator extends QuoteCreatorB2BBase implements QuoteCreator {
  ...
  public ContractUPB2BCreator(String isFakeAddress, String switchType)
      throws FileNotFoundException, IOException {
    super();
    getQuoteProperties(
        ContractConstants.PATH_TO_PROPERTIES_FILE_CREATE_QUOTE_UP, isFakeAddress, switchType);
  }
  ...
  public void setPreconditions(String accountName, String contractStartDate, String contractEndDate)
    ...
    super.setPreconditions(
        ContractConstants.PATH_TO_JSON_FILES_QUOTE_UP_B2B,
        accountName,
        contractStartDate,
        contractEndDate);
    logger.info(
  ...
  public String createContract() throws Exception {
    ...
    login();
    setPreconditions(
        ContractConstants.ACCOUNT_NAME_PREFIX_UP_B2B,
        upStartDate,
        PrepareDataForContract.getTodayDate());
    createQuoteB2B(
        ContractConstants.PATH_TO_JSON_FILES_QUOTE_UP_B2B,
        ContractConstants.PATH_TO_JSON_FILES_CREATE_QUOTE_B2B_UP,
