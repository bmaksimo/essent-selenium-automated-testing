...
public class ContractUPB2CCreator extends QuoteCreatorB2CBase implements QuoteCreator {
	...
	public String createContract() throws Exception {
        ...
        verifyQuoteStatus(ContractConstants.PATH_TO_JSON_FILES_QUOTE_UP_B2C, ContractConstants.SENT_TO_CUSTOMER_EN.toUpperCase(), ContractConstants.ACCEPTED_EN.toUpperCase());
        signatureReceived(ContractConstants.PATH_TO_JSON_FILES_QUOTE_UP_B2C, pricingDate, priceValidUntilDate, signatureReceivedDate);
        verifyQuoteStatus(ContractConstants.PATH_TO_JSON_FILES_QUOTE_UP_B2C, ContractConstants.SIGNATURE_RECEIVED_EN.toUpperCase(), ContractConstants.ACCEPTED_EN.toUpperCase());
        confirmSigning(ContractConstants.PATH_TO_JSON_FILES_QUOTE_UP_B2C, ContractConstants.PATH_TO_JSON_FILES_SIGN_QUOTE_MODAL_TC2_UP, ApiPathsContract.API_SIGN_QUOTE_MODAL_TC2_UP);
        signMandatePaper(ContractConstants.PATH_TO_JSON_FILES_QUOTE_UP_B2C);
        verifyContractCreated(ContractConstants.PATH_TO_JSON_FILES_QUOTE_UP_B2C, ContractConstants.SIGNED_EN.toUpperCase(), ContractConstants.ACCEPTED_EN.toUpperCase());
	...
	public String createContractAndCheckContractStatus() throws Exception {
		...
		if (numberOfAttempts < ContractConstants.MAX_NUMBER_OF_ATTEMPTS_TO_FIND_APPROPRIATE_START_CONTRACT_DATE) {
			...
			contractStatus = checkContractIsActive(ContractConstants.PATH_TO_JSON_FILES_QUOTE_UP_B2C);
