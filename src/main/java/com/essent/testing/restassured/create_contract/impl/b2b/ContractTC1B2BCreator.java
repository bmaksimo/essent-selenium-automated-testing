...
public class ContractTC1B2BCreator extends QuoteCreatorB2BBase implements QuoteCreator {
  ...
  public ContractTC1B2BCreator(String isFakeAddress, String switchType)
  ...
  public String createContract() throws Exception {
    ...
    login();
    setPreconditions(
        ContractConstants.ACCOUNT_NAME_PREFIX_TC1_B2B,
        upStartDate,
        PrepareDataForContract.getTodayDate());
    createQuoteB2B(
        ContractConstants.PATH_TO_JSON_FILES_QUOTE_TC1_B2B,
        ContractConstants.PATH_TO_JSON_FILES_CREATE_QUOTE_B2B_TC1,
        ApiPathsContract.API_CREATE_QUOTE_B2B_TC1);
    verifyQuoteStatus(
        ContractConstants.PATH_TO_JSON_FILES_QUOTE_TC1_B2B,
