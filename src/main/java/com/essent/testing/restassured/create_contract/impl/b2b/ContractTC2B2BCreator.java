...
public class ContractTC2B2BCreator extends QuoteCreatorB2BBase implements QuoteCreator {
	...
	public String createContract() throws Exception {
		...
		signatureReceived(ContractConstants.PATH_TO_JSON_FILES_QUOTE_TC2_B2B, pricingDate, priceValidUntilDate, signatureReceivedDate);
		verifyQuoteStatus(ContractConstants.PATH_TO_JSON_FILES_QUOTE_TC2_B2B, ContractConstants.SIGNATURE_RECEIVED_EN.toUpperCase(), ContractConstants.ACCEPTED_EN.toUpperCase());
		confirmSigning(ContractConstants.PATH_TO_JSON_FILES_QUOTE_TC2_B2B, ContractConstants.PATH_TO_JSON_FILES_SIGN_QUOTE_MODAL_TC2_UP, ApiPathsContract.API_SIGN_QUOTE_MODAL_TC2_UP);
