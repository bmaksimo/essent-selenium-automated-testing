...
public class ContractTC2B2BCreator extends QuoteCreatorB2BBase implements QuoteCreator {
  ...
  public ContractTC2B2BCreator(String isFakeAddress, String switchType)
      throws FileNotFoundException, IOException {
    super();
    getQuoteProperties(
        ContractConstants.PATH_TO_PROPERTIES_FILE_CREATE_QUOTE_TC2, isFakeAddress, switchType);
  }

  public ContractTC2B2BCreator(QuoteB2B quoteB2B) throws FileNotFoundException, IOException {
    super();
    getQuoteProperties(ContractConstants.PATH_TO_PROPERTIES_FILE_CREATE_QUOTE_TC2, quoteB2B);
  }
  ...
  public void setPreconditions(String accountName, String contractStartDate, String contractEndDate)
    ...
    super.setPreconditions(
        ContractConstants.PATH_TO_JSON_FILES_QUOTE_TC2_B2B,
        accountName,
        contractStartDate,
        contractEndDate);
    logger.info(
  ...
  public String createContract() throws Exception {
    ...
    login();
    setPreconditions(
        ContractConstants.ACCOUNT_NAME_PREFIX_TC2_B2B,
        upStartDate,
        PrepareDataForContract.getTodayDate());
    createQuoteB2B(
        ContractConstants.PATH_TO_JSON_FILES_QUOTE_TC2_B2B,
        ContractConstants.PATH_TO_JSON_FILES_CREATE_QUOTE_B2B_TC2,
        ApiPathsContract.API_CREATE_QUOTE_B2B_TC2_UP);
    verifyQuoteStatus(
        ContractConstants.PATH_TO_JSON_FILES_QUOTE_TC2_B2B,
        ContractConstants.PRICED_EN.toUpperCase(),
    ...
    confirmSigning(
        ContractConstants.PATH_TO_JSON_FILES_QUOTE_TC2_B2B,
        ContractConstants.PATH_TO_JSON_FILES_SIGN_QUOTE_MODAL_TC2_UP,
        ApiPathsContract.API_SIGN_QUOTE_MODAL_TC2_UP);
  ...
  public String createContractAndCheckContractStatus() throws Exception {
    ...
    contractStatus = checkContractIsActive(ContractConstants.PATH_TO_JSON_FILES_QUOTE_TC2_B2B);
    ...
    logger.info(
        "createContractAndCheckContractStatus: " + this.getClass().getSimpleName() + " - PASSED");
