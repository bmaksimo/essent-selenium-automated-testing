...
public class BillingInvoiceRest extends BillingRootClient {
	...
	public RSGetInvoiceIDsForBillingIDsResp getInvoiceIDsForBillingIDs(RSGetInvoiceIDsForBillingIDs request) {
	...
	public ReverseDunningInvoiceResponse reverseDunningCostInvoice(ReverseDunningInvoiceRequest request) {
	...
	public RecalculateInvoicedMeteredResponse recalculateInvoicedMetered(RecalculateInvoicedMeteredRequest request) {

		return call(recalculateInvoicedMetered, request, RecalculateInvoicedMeteredResponse.class);
	}

	public RecalcInvoicedAdvanceResponse recalculateInvoicedAdvance(RecalcInvoicedAdvanceRequest request) {
