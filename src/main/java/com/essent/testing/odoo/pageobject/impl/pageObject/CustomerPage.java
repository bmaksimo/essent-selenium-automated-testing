...
public class CustomerPage extends Component {
  ...
  private static final String TAB_MENU_XPATH =
      "//li[@class='ui-state-default ui-corner-top']/a[contains(text(),'${" + NAME_TAB + "}')] ";
  private static final String JOURNAL_ENTRY_ROW =
      "//table[@class='oe_list_content'][1]//tr[1]//td[@data-field='move_id'][1]//a";
  private static final String ACTIVE_CHECKBOX =
      "//div[@class='oe_form_nosheet']//tbody/tr[3]/td[2]//input";
  private static final String SENT_TO_CUSTOMER_CHECKBOX =
      "//td[@data-field='sent_to_customer']/input";
  ...
  public void buttonJournalItemsClicked(String label) {
    ...
    WebElement webElement =
        seleniumDriver.findElementWhenVisible(
            By.xpath("//button//span[contains(., '" + label + "')]"));
  ...
  public void rightBoxButtonClicked(String button) {
    ...
    seleniumDriver.waitAndClick(
        seleniumDriver.findElementWhenVisible(
            By.xpath("//div[@class='oe_right oe_button_box']//div[contains(.,'" + button + "')]")));
  }
