...
public class JournalEntriesPage extends Component {
  ...
  public void clickOnCreateJournalEntry() {
    seleniumDriver
        .findElementWhenVisible(By.xpath("//button[@class='oe_button oe_list_add oe_highlight']"))
        .click();
  }

  public void chooseDiverseDagboekKlanten(String journal) {
    seleniumDriver
        .findElementWhenVisible(By.xpath("(//input[@class='ui-autocomplete-input'])[1]"))
        .sendKeys(journal);
    seleniumDriver
        .findElementWhenVisible(By.xpath("//a[contains(text(),'Diverse dagboek klanten (EUR)')]"))
        .click();
  }
  ...
  public void clickOnAddAnItem() {
    WebElement addItemLink =
        seleniumDriver.findElementWhenVisible(By.xpath("//a [contains(text(),\"Add an item\")]"));
  ...
  public void saveJournal() {
    WebElement saveButton =
        seleniumDriver.findElementWhenVisible(
            By.xpath("//button[@class='oe_button oe_form_button_save oe_highlight']"));
    seleniumDriver.moveToElementAndClick(saveButton);
  }

  public void setName(String name) {
    seleniumDriver
        .findElementWhenVisible(By.xpath("//span[@data-fieldname='name']/input"))
        .sendKeys(name);
  }

  public WebElement findPartnerElement() {
    return seleniumDriver.findElementWhenVisible(
        By.xpath("//span[@data-fieldname='partner_id']/div/input"));
  }
  ...
  public void setPartner(String partner) {
    ...
    WebElement partnerLink =
        seleniumDriver.findElementWhenVisible(By.xpath("//a[contains(text(),'B2B_UP')]"));
    seleniumDriver.moveToElementAndClick(partnerLink);
  }

  public WebElement findCreditElement() {
    return seleniumDriver.findElementWhenVisible(
        By.xpath("//span[@data-fieldname='credit']/input"));
  }
  ...
  public WebElement journalItemsCheckBox() {
    return seleniumDriver.findElementWhenVisible(
        By.xpath(
            ("//div[@class='oe_view_manager oe_view_manager_current'][2]//input[@class='oe_list_record_selector']")));
  }
  ...
  public WebElement findMoreElement() {
    return seleniumDriver.findElementWhenVisible(
        By.xpath("(//button[@class='oe_dropdown_toggle oe_dropdown_arrow'])[8]"));
  }
  ...
  public void clickOnConfirm() {
    seleniumDriver
        .findElementWhenVisible(
            By.xpath("//button[@class='oe_button oe_form_button oe_highlight']"))
        .click();
  }

  public WebElement reconcile(Integer row) {
    return seleniumDriver.findElementWhenVisible(
        By.xpath("(//td[@data-field='reconcile_id'])[" + row + "]/a"));
  }
