...
//    }
    ...
    public void clickOnCreateJournalEntery(){
        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//button[@class='oe_button oe_list_add oe_highlight']")));
    }

    public void clickOnDropDownButtonJournal(){
        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//span[@class='oe_m2o_drop_down_button']")));
    }

    public void chooseDiverseDagboekKlanten(String journal){
        seleniumDriver.waitAndSendKeysOdoo(seleniumDriver.findElementWhenVisibleOdoo(By.xpath("(//input[@class='ui-autocomplete-input'])[1]")), journal);
        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenClickableOdoo(By.xpath("//a[contains(text(),'Diverse dagboek klanten (EUR)')]")));
    }

    public WebElement findDataDocumentElement(){
        return seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//input[@name='date_document']"));
    }

    public void dateDocumentIsToday(){
        findDataDocumentElement().click();
        findDataDocumentElement().clear();
        seleniumDriver.waitAndSendKeysOdoo(findDataDocumentElement(), date);
    }

    public void clickOnAddAnItem(){
        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//a [contains(text(),\"Add an item\")]")));
    }

    public void saveJournal(){
        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//button[@class='oe_button oe_form_button_save oe_highlight']")));
    }
    public void postJournal(){
        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//button[@class='oe_button oe_form_button oe_highlight']")));
    }

    public void setName(String name){
        seleniumDriver.waitAndSendKeysOdoo(seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//span[@data-fieldname='name']/input")), name);
    }

    public void setPartner(String partner){
        seleniumDriver.waitAndSendKeysOdoo(seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//span[@data-fieldname='partner_id']/div/input")), partner);
        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenClickableOdoo(By.xpath("(//li[@class='ui-menu-item']/a)[2]")));
    }

    public WebElement findAccountElement(){
        return seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//span[@data-fieldname='account_id']/div/input"));
    }

    public void setAccout(String account){
        Sleeper.sleepTightInSeconds(4);
        seleniumDriver.waitAndClickOdoo(findAccountElement());
        findAccountElement().clear();
        seleniumDriver.waitAndSendKeysOdoo(findAccountElement(), account);
//        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//span[@data-fieldname='account_id']//span[@class='oe_m2o_drop_down_button']/img")));
//        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenClickableOdoo(By.xpath("(//li[@class='ui-menu-item']/a)[4]")));
        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenClickableOdoo(By.xpath("//a[contains(text(),'580100 B2C-B2B  OVERBOEKINGEN')]")));
    }

    public WebElement findDebitElement(){
        return seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//span[@data-fieldname='debit']/input"));
    }

    public void setDebit(String debit){
        seleniumDriver.waitAndClickOdoo(findDebitElement());
        findDebitElement().clear();
        seleniumDriver.waitAndSendKeysOdoo(findDebitElement(), debit);
    }

    public WebElement findCreditElement(){
        return seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//span[@data-fieldname='credit']/input"));
    }

    public void setCredit(String credit){
        seleniumDriver.waitAndClickOdoo(findCreditElement());
        findCreditElement().clear();
        seleniumDriver.waitAndSendKeysOdoo(findCreditElement(), credit);
    }
    ...
    public WebElement journalItemsCheckBox(Integer row){
        return  seleniumDriver.findElementWhenVisibleOdoo(By.xpath(("(//tbody/tr["+row+"]/th/input)[2]")));
    }
    ...
    public WebElement findMoreElement(){
        return seleniumDriver.findElementWhenVisibleOdoo(By.xpath("(//button[@class='oe_dropdown_toggle oe_dropdown_arrow'])[8]"));
    }

    public void clickOnMoreMenuItem(String item){
        seleniumDriver.waitAndClickOdoo(findMoreElement());
        seleniumDriver.waitAndClickOdoo(seleniumDriver.findElementWhenVisibleOdoo(By.xpath("//a[contains(text(),'"+item+"')]")));
    }
    ...
    public WebElement reconcile(Integer row){
        return seleniumDriver.findElementWhenVisibleOdoo(By.xpath("(//td[@data-field='reconcile_id'])["+row+"]/a"));
    }
