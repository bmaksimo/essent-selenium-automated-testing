...
public enum B2CQuoteElements {
  ...
  EMAIL(
      "SELECTOR", "#leads-contact-details-contact-details-type-email-contact-details-value-field"),
  MOBILE_NR(
      "SELECTOR",
  ...
  ELECTRICITY_EAN_CODE(
      "SELECTOR",
      "#ean-c-accounts-aos-quotes-aos-products-quotes-c-0-f-94-c-2-f-72-e-0-51-b-9-ce-93-58930799-ecf-1-field");
