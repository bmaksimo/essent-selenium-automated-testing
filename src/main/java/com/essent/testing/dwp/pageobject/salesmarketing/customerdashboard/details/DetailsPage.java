package com.essent.testing.dwp.pageobject.salesmarketing.customerdashboard.details;
...
public class DetailsPage extends Component {
  ...
  private static final String NUMBER_BILLING_CUSTOMER =
      "//list[@list-key='BillingCustomerOnaccount']//tr[@class='list__row']";
  ...
  private static final String BANK_ACCOUNT =
      "//list[@list-key='BillingCustomerOnaccount']//tbody//td[2]//span[1]";
  private static final String PAYMENT_METHOD =
      "//list[@list-key='BillingCustomerOnaccount']//tbody//td[3]//span[2]";
  private static final String ACCOUNT_BLOCK_START_DATE =
      "//*[@id=\"rows\"]/tr[1]/td[2]/list-simple-two-liner-cell/p/span[1]";
  private static final String ACCOUNT_BLOCK_END_DATE =
      "//list[@list-key='accountBlockReasonsForAccountList']//tr[1]/td[3]/list-simple-two-liner-cell/p";
  private static final String PREFERENCES_EMAIL_ADDRESS_LEGAL =
      "paym-details-accounts-contacts-primary-contact-c-1-contacts-contact-details-contact-details-type-email-contact-details-value-field";
  private static final String PREFERENCES_EMAIL_ADDRESS_GENERAL =
      "contacts-contacts-contact-details-contact-details-type-email-contact-details-value-field";
  private static final String COMMUNICATION_PREFERENCES_UPDATED_SUCCESS_MESSAGE =
      "//div/focus-mode/focus-mode-content/div/div/div[2]/flash-message-renderer/flash-message";
  private static final String INVOICE_BLOCK_END_DATE =
      "//list[@list-key='invoiceBlockReasonsForInvoice']//tr[1]/td[3]/list-simple-two-liner-cell/p";
  ...
  public void emailAddressInputIsCleared(String preference) {
    ...
    Sleeper.sleepTightInSeconds(5);
    String id =
        preference.equalsIgnoreCase("Algemeen")
            ? PREFERENCES_EMAIL_ADDRESS_GENERAL
            : PREFERENCES_EMAIL_ADDRESS_LEGAL;
  ...
  public String getCommunicationPreferencesUpdatedMessage() {
    ...
    return seleniumDriver
        .findElementWhenPresent(By.xpath(COMMUNICATION_PREFERENCES_UPDATED_SUCCESS_MESSAGE))
        .getText();
  }
  ...
  public void clickOnListItemInRow(String table, String value) {
    ...
    int rowTotal =
        seleniumDriver
            .findElements(
                By.xpath("" + TABLE_IDENTIFIER + " = '" + table + "']//tr[@class='list__row']"))
            .size();
    boolean isDisplayed;
                  ...
                  .findElements(
                      By.xpath(
                          ""
                              ...
                              + "']//tr[@class='list__row']["
                              + i
                              + "]//td[@class='list__cell cell__text'][4]//span[contains(., '"
                              + value
                              + "')]"))
                  .size()
              > 0;
  ...
  public WebElement getModalName(String modal) {
    return seleniumDriver.findElementWhenVisible(
        By.xpath("//h5[normalize-space()= '" + modal + "']"));
  }

  public WebElement getEmcIdElement() {
    return seleniumDriver.findElementWhenVisible(
        By.xpath(
            "//list[@list-key='CommunicationonInteraction']//td[4]//list-simple-two-liner-cell//span[1]"));
  }
}
