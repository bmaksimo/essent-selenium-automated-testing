...
public class BaseObjectPage extends Component {
    ...
    private static final String plusMenuXPath = "//list-row-action[normalize-space(@label)=${"+replacementKey+"}]/a";
    ...
    private static final String labelClickXPath = "//validation-wrapper[@label='${" + replacementKey + "}']//option[@label = ${'" + replacementKey1 + "}']";
