...
public class CreateMoveOAPage extends Component {
  ...
  private static final String COMMUNICATION_CHANNEL =
      "//*[@id='dwp-move-interaction-channel-field']/option[@label='${" + REPLACEMENT_KEY + "}']";
  private static final String REASON_OF_MOVE_ELEMENT_ID = "dwp-move-reason-field";
  private static final String REASON_OF_MOVE =
      "//*[@id='dwp-move-reason-field']/option[@label='${" + REPLACEMENT_KEY + "}']";
  private static final String MOVE_DATE_ID = "dwp-move-date-field";
  private static final String PREVIOUS_METER =
      "(//*[@id='dwp|previousIndex']/div/strong)[${" + REPLACEMENT_KEY + "}]";
  private static final String METER_READING_DATE =
      "(//validation-wrapper[@label='Datum meteropname']//datepicker-form-element//div[@class='input-holder']/input)[2]";
  private static final String METER_READING =
      "(//validation-wrapper[@label='Meterstand']//div[@class='auto-complete']/input)[2]";
  ...
  public void chooseCommunicationChannel(String channel) {
    ...
    seleniumDriver.waitAndClick(
        seleniumDriver.findElementWhenVisible(By.xpath(communicationChannel)));
    seleniumDriver.waitForRequestsToFinish();
  }
  ...
  public void chooseMoveDate(String date) {
    ...
    seleniumDriver.waitAndSendKeys(
        seleniumDriver.findElementWhenVisible(By.id(MOVE_DATE_ID)), date);
    seleniumDriver.waitForRequestsToFinish();
  }
  ...
  public void chooseMeterReadingDate(String date) {
    seleniumDriver.waitForRequestsToFinish();
    seleniumDriver.waitAndSendKeys(
        seleniumDriver.findElementWhenVisible(By.xpath(METER_READING_DATE)), date);
  }

  public void setMeterReading(String mr) {
    seleniumDriver.waitForRequestsToFinish();
    seleniumDriver.waitAndSendKeys(
        seleniumDriver.findElementWhenVisible(By.xpath(METER_READING)), mr);
  }
}
