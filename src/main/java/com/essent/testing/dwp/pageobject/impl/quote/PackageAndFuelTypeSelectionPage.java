...
public class PackageAndFuelTypeSelectionPage extends QuoteCreationGuidedStep {
  ...
  private final String TARIFFSHEET_ID =
      "accounts-aos-quotes-aos-products-quotes-tariffsheet-id-field";
  ...
  public boolean fillInFormData() {
    ...
    try {
      if (null != tariffData.getTariffSheet()) {
        WebElement tariffSheetDropDown =
            seleniumDriver.findElementWhenClickable(By.id(TARIFFSHEET_ID));
