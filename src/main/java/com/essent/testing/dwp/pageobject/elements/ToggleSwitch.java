...
public interface ToggleSwitch extends Button {
   ...
   * @return <code>true</code>, when the toggle element is switched on, and <code>false</code>
   *     otherwise.
   */
  boolean isOn();
  ...
  /**
   * Is doing nothing when the element, located by given parameters, is visible. Throws Selenium
   * exception otherwise.
   *
   * @param card
   * @param label
