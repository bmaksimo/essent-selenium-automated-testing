package com.essent.testing.dwp.pageobject.contractingswitching;
...
public class QuotesListPage extends Component {
  ...
  public String getOfferteNumberAsString() throws Exception {
    ...
    return findElementWithRetries(By.xpath("//list-link-bold-top-two-liner-cell//a/h5"), 10)
        .getText();
  }
  ...
  public void offerteNumberFieldSendKeys(String input) {
    ...
    seleniumDriver.waitAndSendKeys(
        seleniumDriver.findElementWhenVisible(By.id("number-default-value-field")), input);
  }

  public void markAsDoneOplossingSendKeys(String input) {
    seleniumDriver.waitForRequestsToFinish();
    seleniumDriver.waitAndSendKeys(
        seleniumDriver.findElementWhenVisible(By.id("task-resolution-c-field")), input);
  }
  ...
  public WebElement calendar() {
    return seleniumDriver.findElementWhenVisible(
        By.xpath("//*[@id=\"signature_received_date_c\"]//div[@class='input__with-button']/span"));
  }
  ...
  public void setSignatureReceivedDate(String date) {
    ...
    seleniumDriver.waitAndSendKeys(
        seleniumDriver.findElementWhenVisible(
            By.xpath(
                "//validation-wrapper[@label='Datum handtekening ontvangen']//input[@id='signature-received-date-c-field']")),
        date);
