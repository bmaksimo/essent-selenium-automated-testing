package com.essent.testing.dwp.pageobject.salesmarketing.customerdashboard.service;
...
public class ServicePage extends Component {
  ...
  private static final String CASE_TOPIC =
      "//list[@list-key='CasesOnAccount']//td[@class='list__cell cell__text'][3]/list-simple-two-liner-cell/p";
  private static final String REPLACEMENT_KEY = "replacement_key";
  private static final String INTERACTION_TYPE =
      "//list-simple-two-liner-cell[@line-1='${" + REPLACEMENT_KEY + "}']/p/span[1]";
  private static final String INTERACTION_ONDERWERP =
      "//list-simple-two-liner-cell[@line-1='${" + REPLACEMENT_KEY + "}']/p/span[2]";
  private static final String CASE_NUMBER =
      "//list[@list-key=\"InteractionsOnAccount\"]//td[7]//div//h5[1]";
  private static final String INTERACTION_VERWANTE_CASE =
      "//*[@id='rows']/tr[1]/td[7]/list-link-bold-top-two-liner-cell/div/a";
  ...
  public void findRejectionReason(String input) {
    ...
    Assert.assertTrue(
        seleniumDriver
            .findElementWhenVisible(By.xpath("(//span[.='" + input + "'])[1]"))
            .isDisplayed());
  }
  ...
  public void goToProspect() {
    ...
    seleniumDriver.waitAndClick(
        seleniumDriver.findElementWhenVisible(By.linkText("Go to prospect")));
  ...
  public void gotoGLNAccount() {
    seleniumDriver.waitForRequestsToFinish();
    seleniumDriver.waitAndClick(
        seleniumDriver.findElementWhenVisible(By.linkText("Go to GLN Account")));
    Sleeper.sleepTightInSeconds(10);
  }
  ...
  public String getSecondInteractionOnderwerp() {
    return seleniumDriver
        .findElementWhenVisible(
            By.xpath(
                "//list[@list-key='InteractionsOnAccount']//tr[3]//td[3]//list-simple-two-liner-cell//span[2]"))
        .getText();
  }
}
