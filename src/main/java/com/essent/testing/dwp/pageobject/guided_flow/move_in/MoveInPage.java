package com.essent.testing.dwp.pageobject.guided_flow.move_in;

import com.essent.testing.dwp.pageobject.impl.Component;
import org.openqa.selenium.By;

public class MoveInPage extends Component {
  public void setNewMoveAddress(
      String address, String houseNumber, String postalCode, String City) {
    ...
    seleniumDriver.waitAndClick(
        seleniumDriver.findElementWhenClickable(
            By.xpath(
                "//*[@id=\"aos-products-quotes-addresses-aos-products-quotes-field-container\"]//ul/li[1]/a/b")));
    seleniumDriver.waitAndSendKeys(
    ...
    seleniumDriver.waitAndClick(
        seleniumDriver.findElementWhenClickable(
            By.xpath(
                "//*[@id=\"aos-products-quotes-addresses-aos-products-quotes-field-container\"]//ul/li/a/b")));
  }
}
