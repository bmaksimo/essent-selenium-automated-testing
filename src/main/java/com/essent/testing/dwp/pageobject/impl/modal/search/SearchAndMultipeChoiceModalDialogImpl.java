...
public class SearchAndMultipeChoiceModalDialogImpl extends Component
  ...
  private static final By ID_MODAL_SEARCH_FIELD_LOCATOR = By.id("search-input");
  ...
  public void search(String label) {
    seleniumDriver.waitAndClick(
        findElementWhenVisible(By.xpath(String.format(XPATH_MODAL_SEARCH_BUTTON_TEMPLATE, label))));
  }
