...
public class InvoiceListPage extends Component {
  ...
  private static final String NEW_PAYMENT_DATE_SELECTOR =
      "(//list-simple-two-liner-cell[@icon='null']//span)[6]";
  ...
  public void openListOption(String option) {
    ...
    seleniumDriver.waitAndClick(
        findElementWhenVisible(By.xpath(createQuery(LIST_OPTION_SELECTOR, "option", option))));
  }
