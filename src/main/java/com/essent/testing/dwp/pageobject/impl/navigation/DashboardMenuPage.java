...
public class DashboardMenuPage extends Component {
    ...
    private static final String DASHBOARD_MENU_BUTTON = "//a[@class='col-1-4 nav-item']/span[@class='";
    private static final String CLICKED_DASHBOARD_MENU_BUTTON = "//a[@class='col-1-4 nav-item active']/span[@class='";
    ...
    private WebElement getDashboardElement(String name) {
        ...
        return seleniumDriver.findElementWhenVisible(By.xpath(DASHBOARD_MENU_BUTTON + menuMap.get(name) + "']"));
    }

    private Optional<WebElement> getDashboardElementOptional(String name) {
        seleniumDriver.waitForRequestsToFinish();
        return seleniumDriver.findElementOptional(By.xpath(DASHBOARD_MENU_BUTTON + menuMap.get(name) + "']"));
    }

    private boolean isDashboardElementClicked(String name) {
        seleniumDriver.waitForRequestsToFinish();
        Optional<WebElement> clickedDashboardElement = seleniumDriver.findElementOptional(By.xpath(CLICKED_DASHBOARD_MENU_BUTTON + menuMap.get(name) + "']"));
