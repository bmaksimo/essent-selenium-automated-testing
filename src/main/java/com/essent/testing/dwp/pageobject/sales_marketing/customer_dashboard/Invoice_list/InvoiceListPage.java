...
public class InvoiceListPage extends Component {
  ...
  public void checkPayDate() {
    ...
    final String newPayDate =
        findElementWhenVisible(By.xpath("(//list-simple-two-liner-cell[@icon='null']//span)[6]"))
            .getText();
    Assert.assertFalse(
        "Date was not changed. Old date is : " + payDate + ", and new date is same : " + newPayDate,
        newPayDate.equalsIgnoreCase(payDate));
  }
  ...
  public void findIssuedAndPayDelay(String type, String option) {
    ...
    int counter = 1;
    String payType =
        findElementWhenVisible(By.xpath("//*[@id='rows']/tr[1]/td[8]//span[1]")).getText();
    while (!payType.equalsIgnoreCase(type)) {
      counter = counter + 2;
      payType =
          findElementWhenVisible(By.xpath("//*[@id='rows']/tr[" + counter + "]/td[8]//span[1]"))
              .getText();
    }
    payDate =
        findElementWhenVisible(By.xpath("//*[@id='rows']/tr[" + counter + "]/td[7]//span[2]"))
            .getText();
    findElementWhenVisible(
            By.xpath("(//*[@id='rows']/tr[" + counter + "]/td[10]/list-plus-cell//a)[1]"))
        .click();
