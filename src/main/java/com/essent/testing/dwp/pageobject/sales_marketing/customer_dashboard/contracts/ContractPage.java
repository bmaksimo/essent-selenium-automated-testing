...
public class ContractPage extends Component {
  ...
  public String checkSuccessMessage() {
    seleniumDriver.waitForRequestsToFinish();
    String messageProductChange =
        seleniumDriver.findElementWhenPresent(By.xpath(LABELFORPRODUCTCHANGE)).getText();
  ...
  public void searchForEanCode(String eanCode) {
    ...
    seleniumDriver.waitForRequestsToFinish();
    seleniumDriver.waitAndClick(
        findElementWhenVisible(By.xpath("//div[@class='multi-select__results']//ul[2]")));
    seleniumDriver.waitForRequestsToFinish();
    seleniumDriver.waitAndClick(
  ...
  public String getActualValuesOfInvoicesAsString() {
    ...
    String secondInvoice =
        seleniumDriver.findElementWhenVisible(By.xpath(SECOND_INVOICE)).getText();
    String thirdInvoice = seleniumDriver.findElementWhenVisible(By.xpath(THIRD_INVOICE)).getText();

    StringBuilder sb;
    sb = new StringBuilder();

    return sb.append(firstInvoice)
        .append(' ')
        .append(secondInvoice)
        .append(' ')
        .append(thirdInvoice)
        .toString();
  }

  public boolean checkIsInvoicesAmountsAsStringCorrect(
      String amountInvoicesCombination1,
      String amountInvoicesCombination2,
      String amountInvoicesCombination3,
      String amountInvoicesCombination4,
      String actualValuesOfInvoices) {
    boolean matchingValuesOfInvoices = false;
    if (amountInvoicesCombination1.equals(actualValuesOfInvoices)
        || amountInvoicesCombination2.equals(actualValuesOfInvoices)
        || amountInvoicesCombination3.equals(actualValuesOfInvoices)
        || amountInvoicesCombination4.equals(actualValuesOfInvoices)) {
  ...
  public boolean compareActualAndExpectedBalances(
      String balance1, String balance2, String balance3, String actualBalance) {
