...
public class ContractPage extends Component {
    ...
    public void checkInvoiceOpenBalance(String key) {
        seleniumDriver.waitForRequestsToFinish();
        String xpathAction = createQuery(INVOICE_OPEN_BALANCE, REPLACEMENT_KEY, key);
        seleniumDriver.waitAndClick(seleniumDriver.findElementWhenVisible(By.xpath(xpathAction)));
    }
