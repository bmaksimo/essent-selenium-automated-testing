...
public class SearchContractLinesDialog extends Component implements ConfirmDialog {
  ...
  private static final By SELECTOR = By.cssSelector(".view__modal .modal__header");
  ...
  public void searchContractLine(String searchInput) {
    ...
    WebElement searchButton =
        seleniumDriver.findElementWhenVisible(By.xpath("//input[@type='submitSearchResult']"));
    searchButton.click();
    Sleeper.sleepTightInSeconds(1);
    searchButton.click();

    String checkBoxesQuery =
        createQuery(
            "//label[starts-with(normalize-space(), '${text}')]/input[@type='checkbox']",
            "text",
            searchInput);
    ...
    given()
        ...
        .until(
            () ->
                CollectionUtils.isNotEmpty(seleniumDriver.findElements(By.xpath(checkBoxesQuery))));
