package com.essent.testing.selenium.angular;

import com.essent.testing.selenium.SeleniumPage;
...
public class AngularSeleniumPage extends SeleniumPage {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(AngularSeleniumPage.class);
  ...
  public void waitUntilAngularPageIsLoaded() {
    super.waitForReady();
    LOG.info(
        "waiting for all angular requests to finish on page at url: "
  ...
  /**
   * Helper method that outputs all IDs on the page you are currently on to system out. Greatly
   * speeds up looking up all IDs for a page.
   */
