...
public class OsUtils {
  private static final OsStrategy strategy;
  ...
  public static ProcessBuilder getRestoreCmd(
  ...
  public static ProcessBuilder getDumpCmd(
      String host, int port, String userId, String db, String dumpLocation) {
  ...
  public static ProcessBuilder getQuery(
      String host, int port, String userId, String db, String query) {
